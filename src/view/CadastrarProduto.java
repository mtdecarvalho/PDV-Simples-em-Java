...
//        CadastrarProduto cadastrar = new CadastrarProduto(parent, opc, pf, i);
...
//    public CadastrarProduto(java.awt.Frame parent, opcCadastro opc, ClientePF pf, int i){
//        super(parent, true);
//        confirmado = false;
//        this.opc = opc;
//        pfAlterado = pf;
...
//            tbxQtdEstoque.setText(pf.getTelefone());
//            tbxUnidade.setText(pf.getTelComercial());
//            tbxPreco.setText(pf.getTelCel());
//            tbxUltimaVenda.setText(pf.getFAX());
//        }    
//    }
